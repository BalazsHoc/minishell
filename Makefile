...
SRCS_PARSING	= parsing.c init_1.c make_history.c none_sense_here_doc.c one_of_those.c  init_paths.c init_ops.c parsing_utils_1.c parsing_utils_2.c parsing_utils_3.c parsing_utils_4.c parsing_utils_5.c parsing_utils_6.c checks_1.c checks_2.c checks_3.c count.c count_utils.c init_cmnds/init_cmnds.c init_cmnds/init_cmnds_exp_1.c init_cmnds/init_cmnds_exp_2.c init_cmnds/init_cmnds_exp_3.c init_cmnds/init_cmnds_exp_count_1.c init_cmnds/init_cmnds_exp_count_2.c init_cmnds/init_cmnds_exp_count_3.c init_cmnds/init_cmnds_utils_1.c init_cmnds/init_cmnds_utils_2.c init_cmnds/init_cmnds_utils_3.c init_cmnds/init_cmnds_utils_4.c
...
DIR_EXEC		= srcs/exec/
SRCS_EXEC		= exec.c exec_utils_1.c exec_utils_2.c exec_mini/mini_cd_1.c exec_mini/mini_cd_2.c exec_mini/mini_exit_1.c exec_mini/mini_exit_2.c exec_mini/mini_exit_3.c exec_mini/mini_export_1.c exec_mini/mini_export_2.c exec_mini/mini_export_3.c exec_mini/mini_export_4.c exec_mini/mini_export_5.c exec_mini/mini_export_6.c exec_mini/mini_unset_1.c exec_mini/mini_unset_2.c  exec_mini/start_mini_exec_1.c exec_mini/start_mini_exec_2.c start_exec/start_exec_utils_1.c start_exec/start_exec_utils_2.c start_exec/start_exec_utils_3.c start_exec/start_exec_utils_4.c start_exec/start_exec_utils_5.c  start_exec/start_exec_utils_6.c start_exec/start_exec_utils_7.c start_exec/start_exec_utils_8.c start_exec/start_exec.c
...
DIR_EXIT		= srcs/exit/
SRCS_EXIT		= close_1.c close_2.c exit_clean.c free_1.c free_2.c free_3.c
