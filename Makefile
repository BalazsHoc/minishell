...
SRCS_PARSING	= parsing.c init_1.c make_history.c none_sense_here_doc.c one_of_those.c  init_paths.c init_ops.c parsing_utils_1.c parsing_utils_2.c parsing_utils_3.c parsing_utils_4.c parsing_utils_5.c checks_1.c checks_2.c checks_3.c count.c count_utils.c init_cmnds/init_cmnds.c init_cmnds/init_cmnds_exp_1.c init_cmnds/init_cmnds_exp_2.c init_cmnds/init_cmnds_exp_3.c init_cmnds/init_cmnds_exp_count_1.c init_cmnds/init_cmnds_exp_count_2.c init_cmnds/init_cmnds_exp_count_3.c init_cmnds/init_cmnds_utils_1.c init_cmnds/init_cmnds_utils_2.c init_cmnds/init_cmnds_utils_3.c init_cmnds/init_cmnds_utils_4.c
